...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div id="landingpage_lakbay">
            <div id="landingpage_bg" class="p-5 mb-4 round-3">
        ...
        <footer class="text-center bg-dark" id="landingpage_footer">
            <div class="container text-white py-4 py-lg-5">
                ...
                <p class="text-muted mb-0">Copyright © 2022 Alquin Candelaria</p>
            </div>
        </footer>
    </body>
</html>
