    ...
    <div class="row">
        ...
        <div class="member-entry"> 
            ...
            <div class="member-details"> 
                ...
                <div class="buttons">
                    <a id="btn_Trip" data-toggle="modal" data-target="#profileModal" wire:click="{{ route('open-trip-profile', $trip_profile->id) }}" 
                    class="btn btn-primary btn-sm">Open Profile</a>
